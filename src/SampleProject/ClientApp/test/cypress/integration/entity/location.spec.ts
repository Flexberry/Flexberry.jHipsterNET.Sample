  ...
  describe("new Location page", () => {
    ...
    it("should create an instance of Location", () => {
      cy.get(`[data-cy="streetAddress"]`)
        .type("invoice")
        .should("have.value", "invoice");

      cy.get(`[data-cy="postalCode"]`)
        .type("Республика Borders")
        .should("have.value", "Республика Borders");

      cy.get(`[data-cy="city"]`)
        .type("Lake Jocelynberg")
        .should("have.value", "Lake Jocelynberg");

      cy.get(`[data-cy="stateProvince"]`)
        .type("золотой dot-com")
        .should("have.value", "золотой dot-com");
