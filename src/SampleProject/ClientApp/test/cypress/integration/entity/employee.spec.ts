  ...
  describe("new Employee page", () => {
    ...
    it("should create an instance of Employee", () => {
      cy.get(`[data-cy="firstName"]`)
        .type("Zackery")
        .should("have.value", "Zackery");

      cy.get(`[data-cy="lastName"]`)
        .type("Мартынов")
        .should("have.value", "Мартынов");

      cy.get(`[data-cy="email"]`)
        .type("Brando.43@gmail.com")
        .should("have.value", "Brando.43@gmail.com");

      cy.get(`[data-cy="phoneNumber"]`)
        .type("Большой open")
        .should("have.value", "Большой open");

      cy.get(`[data-cy="hireDate"]`)
        .type("2022-06-29T08:15")
        .should("have.value", "2022-06-29T08:15");

      cy.get(`[data-cy="salary"]`).type("24764").should("have.value", "24764");

      cy.get(`[data-cy="commissionPct"]`)
        .type("97402")
        .should("have.value", "97402");
