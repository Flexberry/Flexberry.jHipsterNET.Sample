...
using SampleProject.Domain.Services;
...
using AuthenticationService = SampleProject.Domain.Services.AuthenticationService;
using IAuthenticationService = SampleProject.Domain.Services.Interfaces.IAuthenticationService;
