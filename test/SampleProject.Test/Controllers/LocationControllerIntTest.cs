...
namespace SampleProject.Test.Controllers
{
    public class LocationsControllerIntTest
    {
        ...
        public async Task UpdateLocation()
        {
            ...
            var response = await _client.PutAsync($"/api/locations/{_location.Id}", TestUtil.ToJsonContent(updatedLocation));
            response.StatusCode.Should().Be(HttpStatusCode.OK);
        ...
        public async Task UpdateNonExistingLocation()
        {
            ...
            var response = await _client.PutAsync("/api/locations/1", TestUtil.ToJsonContent(_location));
            response.StatusCode.Should().Be(HttpStatusCode.BadRequest);
