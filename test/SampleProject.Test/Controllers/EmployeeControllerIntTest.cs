...
namespace SampleProject.Test.Controllers
{
    public class EmployeesControllerIntTest
    {
        ...
        public async Task UpdateEmployee()
        {
            ...
            var response = await _client.PutAsync($"/api/employees/{_employee.Id}", TestUtil.ToJsonContent(updatedEmployee));
            response.StatusCode.Should().Be(HttpStatusCode.OK);
        ...
        public async Task UpdateNonExistingEmployee()
        {
            ...
            var response = await _client.PutAsync("/api/employees/1", TestUtil.ToJsonContent(_employee));
            response.StatusCode.Should().Be(HttpStatusCode.BadRequest);
